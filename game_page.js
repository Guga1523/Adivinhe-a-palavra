...
if(word.length < 5){
    // alert("Por favor  digite uma  palavra com 5 ou mais letras")
    console.log("Por favor  digite uma  palavra com 5 ou mais letras");
   return document.getElementById("msg-label").innerHTML = "Por favor  digite uma  palavra com 5 ou mais letras";
}
